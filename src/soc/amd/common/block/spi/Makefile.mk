...
ifneq ($(filter y,$(CONFIG_SOC_AMD_COMMON_BLOCK_PSP_ROM_ARMOR1) $(CONFIG_SOC_AMD_COMMON_BLOCK_PSP_ROM_ARMOR3)),)
all_x86-y += rom_armor_boot_device_rw_nommap.c
smm-y += rom_armor_boot_device_rw_nommap.c
endif # CONFIG_SOC_AMD_COMMON_BLOCK_PSP_ROM_ARMOR1 / ROM_ARMOR3
